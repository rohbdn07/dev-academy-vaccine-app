...
export default function HomePage() {
    ...
    const fetchReceivedVaccine = (...arr) => {
        ...
        const getTotalOrderedItems = totalItems.reduce(
            (total, num) => total + num
        );
                ...
                <div>
                    ...
                    <div className="homepage_wrapper">
                        <div className="homepage_header col-11 mx-auto">
                            ...
                            <p>
                                The given data(s) are categorized into different
                                intresting information. Information are
                                presented in the form of Graphs and textual
                                form.
                            </p>
                        </div>
                        ...
                        <div className="hompage_result col-lg-11 mx-auto">
                            <VaccineResults
                                receivedVaccineArray={
                                    SolarBuddhicareceivedVaccineArray
                                }
