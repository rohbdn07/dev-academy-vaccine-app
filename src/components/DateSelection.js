...
export default function DateSelection() {
  ...
  const fetchVaccinationDateOfAntique = allVaccinationData.filter(
    (allVacccinationItem) => {
      return allAntiquaData.some((antiuqeVaccineItem) => {
        if (allVacccinationItem.sourceBottle === antiuqeVaccineItem.id) {
          ...
          const getVaccinationDate = moment(
            allVacccinationItem.vaccinationDate
          ).format("YYYY-MM-DD");
  ...
  const fetchVaccinationDateOfSolarBuddhica = allVaccinationData.filter(
    (allVacccinationItem) => {
  ...
  const fetchVaccinationDateOfZerpfy = allVaccinationData.filter(
    (allVacccinationItem) => {
  ...
  const fetchTotalVaccinesGivenatSelectedDate = allVaccinationData.filter(
    (item) => {
      const selectedDate = moment(startDate).format("YYYY-MM-DD");
  ...
  const totalOrderedBottlesOnselectedDate =
    fetchArrivedOrderOfAntiuqa.length +
            ...
            <ul className="list-group">
              ...
              <li className="list-group-item d-flex justify-content-between align-items-center">
                ...
                <span className="badge bg-primary rounded-pill">
                  {fetchVaccinationDateOfAntique.length}
                </span>
              </li>
              <li className="list-group-item d-flex justify-content-between align-items-center">
                <p>no. of SolarBuddhica vaccine given:</p>
                <span className="badge bg-success rounded-pill">
                  {fetchVaccinationDateOfSolarBuddhica.length}
                </span>
              </li>
              <li className="list-group-item d-flex justify-content-between align-items-center">
                <p>no. of Zerpfy vaccine given:</p>
                <span className="badge bg-warning rounded-pill">
                  {fetchVaccinationDateOfZerpfy.length}
                </span>
              </li>
              <li className="list-group-item d-flex justify-content-between align-items-center">
