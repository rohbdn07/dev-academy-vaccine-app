...
export default function PieChartAtSelectedDate(props) {
  ...
  const selectedDateData = [
    { name: "Antiqua", value: fetchVaccinationDateOfAntique },
    { name: "SolarBuddhhica", value: fetchVaccinationDateOfSolarBuddhica },
    { name: "Zerpfy", value: fetchVaccinationDateOfZerpfy },
  ];
